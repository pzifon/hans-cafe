            ...
            <div class="col-6">
                ...
                <div class="container  shadow p-3 mb-5 bg-body rounded">
                    ...
                    <div style="text-align:center">
                        ...
                        <div class="row justify-content-center">
                                <img src="{{ asset('storage/img/stamp.png') }}" class="col-3 rounded-circle border border-dark"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <img src="{{ asset('storage/img/gift.png') }}" class="col-3 rounded-circle border border-dark"
                                    style="width:100px;height:100px;border-radius:50%;margin: 25px;padding: 12px;">
            </img>
                            </div>

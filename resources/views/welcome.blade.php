...
<div class="row-sm" style="text-align:center;display:block;width: auto;height:92vh;border: 1px solid white">
  ...
  <button type="button" class="btn btn-secondary" style="border-radius:50px;margin-top: 90px;padding:10px 50px" width="1000">
   <p class="align-middle fs-4" style="margin-bottom: 0px;">See More</p>
  </button>
</div>

<div class="row-sm" style="text-align:center;display:block;width: auto;height:92vh;border: 1px solid white">
  <div class="row" style="text-align:center;display:block;width: auto;height:600px;margin:50px;border: 1px solid black">
    <p class="fw-light fs-1" style="font-style:italic;margin: 40px 0 0 0">- OPEN FOR DINE IN, TAKEOUT, AND DELIVERY - </p>
    <div class="container-md" style="margin-top:50px">
     <div class="row">
      <div class="col">
      ...
      <div class="col">
       <img src="https://source.unsplash.com/random/100x80?sig=4" style="width:300px;height:300px;margin-top: 40px;">
      </div>
     </div>
    </div>
  </div>
